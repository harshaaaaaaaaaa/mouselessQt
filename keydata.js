...

{
  ...
  {
    id: 'intellij',
    appicon: 'qrc:/Images/intellij.png',
    title: 'IntelliJ IDEA',
    category: 'Development',
    description: 'IntelliJ IDEA is a powerful IDE for JVM development. Master these shortcuts for faster coding.',
    sets: [
      {
        title: 'Essential',
        id: 'essential',
        version: 1,
        shortcuts: [
          {title: 'Search Everywhere', keys: ['Shift', 'Shift']},
          {title: 'Find Action', keys: ['Ctrl', 'Shift', 'A']},
          {title: 'Go to Class', keys: ['Ctrl', 'N']},
          {title: 'Go to File', keys: ['Ctrl', 'Shift', 'N']},
          {title: 'Recent Files', keys: ['Ctrl', 'E']},
          {title: 'Run', keys: ['Shift', 'F10']},
          {title: 'Debug', keys: ['Shift', 'F9']},
          {title: 'Refactor This', keys: ['Ctrl', 'Alt', 'Shift', 'T']},
          {title: 'Show Intention Actions', keys: ['Alt', 'Enter']},
          {title: 'Format Code', keys: ['Ctrl', 'Alt', 'L']},
        ],
      },
    ],
  },
  {
    id: 'pycharm',
    appicon: 'qrc:/Images/pycharm.png',
    title: 'PyCharm',
    category: 'Development',
    description: 'PyCharm is the Python IDE. Speed up your Python development with these shortcuts.',
    sets: [
      {
        title: 'Essentials',
        id: 'essential',
        ...
        shortcuts: [
          ...
          {title: 'Debug', keys: ['Shift', 'F9']},
          {title: 'Search Everywhere', keys: ['Shift', 'Shift']},
          {title: 'Find in Files', keys: ['Ctrl', 'Shift', 'F']},
          {title: 'Refactor Rename', keys: ['Shift', 'F6']},
          {title: 'Reformat Code', keys: ['Ctrl', 'Alt', 'L']},
          {title: 'Optimize Imports', keys: ['Ctrl', 'Alt', 'O']},
          {title: 'Go to Declaration', keys: ['Ctrl', 'B']},
          {title: 'Show Documentation', keys: ['Ctrl', 'Q']},
          {title: 'Terminal', keys: ['Alt', 'F12']},
        ],
      },
    ],
  },
  {
    id: 'atom',
    appicon: 'qrc:/Images/atom.png',
    title: 'Atom',
    category: 'Development',
    description: 'Atom is a hackable text editor. These shortcuts will boost your editing speed.',
    sets: [
      {
        title: 'Editing',
        id: 'editing',
        version: 1,
        shortcuts: [
          {title: 'Command Palette', keys: ['Ctrl', 'Shift', 'P']},
          {title: 'Find in Project', keys: ['Ctrl', 'Shift', 'F']},
          {title: 'Go to Line', keys: ['Ctrl', 'G']},
          {title: 'Duplicate Line', keys: ['Ctrl', 'Shift', 'D']},
          {title: 'Delete Line', keys: ['Ctrl', 'Shift', 'K']},
          {title: 'Toggle Comment', keys: ['Ctrl', '/']},
          {title: 'Fuzzy Finder', keys: ['Ctrl', 'T']},
          {title: 'Select Word', keys: ['Ctrl', 'D']},
          {title: 'Split Pane', keys: ['Ctrl', 'K', 'right']},
          {title: 'Settings', keys: ['Ctrl', ',']},
        ],
      },
    ],
  },
  {
    id: 'sublime',
    appicon: 'qrc:/Images/sublime.png',
    title: 'Sublime Text',
    category: 'Development',
    description: 'Sublime Text is a sophisticated text editor. Navigate and edit with lightning speed.',
    sets: [
      {
        title: 'Essentials',
        id: 'essential',
        ...
        shortcuts: [
          {title: 'Command Palette', keys: ['Ctrl', 'Shift', 'P']},
          {title: 'Go to Anything', keys: ['Ctrl', 'P']},
          {title: 'Go to Symbol', keys: ['Ctrl', 'R']},
          {title: 'Multi-select', keys: ['Ctrl', 'D']},
          {title: 'Select Line', keys: ['Ctrl', 'L']},
          {title: 'Split View', keys: ['Alt', 'Shift', '2']},
          {title: 'Toggle Sidebar', keys: ['Ctrl', 'K', 'Ctrl', 'B']},
          {title: 'Find in Files', keys: ['Ctrl', 'Shift', 'F']},
          {title: 'Quick Switch Project', keys: ['Ctrl', 'Alt', 'P']},
          {title: 'Goto Definition', keys: ['F12']},
        ],
      },
    ],
  },
  {
    id: 'notion',
    appicon: 'qrc:/Images/notion.png',
    title: 'Notion',
    category: 'Productivity',
    description: 'Notion is an all-in-one workspace. Navigate your notes and databases faster.',
    sets: [
      {
        title: 'Navigation',
        id: 'navigation',
        version: 1,
        shortcuts: [
          {title: 'Quick Find', keys: ['Ctrl', 'P']},
          {title: 'Go Back', keys: ['Ctrl', '[']},
          {title: 'Go Forward', keys: ['Ctrl', ']']},
          {title: 'Toggle Sidebar', keys: ['Ctrl', '\\']},
          {title: 'New Page', keys: ['Ctrl', 'N']},
          {title: 'Search', keys: ['Ctrl', 'Shift', 'P']},
          {title: 'Dark Mode', keys: ['Ctrl', 'Shift', 'L']},
          {title: 'Create To-Do', keys: ['Ctrl', 'Shift', '1']},
          {title: 'Create Heading 1', keys: ['Ctrl', 'Alt', '1']},
          {title: 'Toggle Bold', keys: ['Ctrl', 'B']},
        ],
      },
    ],
  },
  {
    id: 'zoom',
    appicon: 'qrc:/Images/zoom.png',
    title: 'Zoom',
    category: 'Communication',
    description: 'Zoom video conferencing shortcuts for productive meetings.',
    sets: [
      {
        ...
        version: 1,
        shortcuts: [
          {title: 'Mute/Unmute', keys: ['Alt', 'A']},
          {title: 'Start/Stop Video', keys: ['Alt', 'V']},
          {title: 'Share Screen', keys: ['Alt', 'Shift', 'S']},
          {title: 'Start/Stop Recording', keys: ['Alt', 'R']},
          {title: 'Pause/Resume Recording', keys: ['Alt', 'P']},
          {title: 'Switch Camera', keys: ['Alt', 'N']},
          {title: 'Chat', keys: ['Alt', 'H']},
          {title: 'Participants', keys: ['Alt', 'U']},
          {title: 'Raise Hand', keys: ['Alt', 'Y']},
          {title: 'End Meeting', keys: ['Alt', 'Q']},
        ],
      },
    ],
  },
  {
    id: 'vlc',
    appicon: 'qrc:/Images/vlc.png',
    title: 'VLC Media Player',
    category: 'Media',
    description: 'VLC is a versatile media player. Control playback without the mouse.',
    sets: [
      {
        title: 'Playback',
        id: 'playback',
        ...
        shortcuts: [
          ...
          {title: 'Stop', keys: ['S']},
          {title: 'Next', keys: ['N']},
          {title: 'Previous', keys: ['P']},
          {title: 'Fullscreen', keys: ['F']},
          {title: 'Volume Up', keys: ['Ctrl', 'up']},
          {title: 'Volume Down', keys: ['Ctrl', 'down']},
          {title: 'Mute', keys: ['M']},
          {title: 'Jump Forward', keys: ['Shift', 'right']},
          {title: 'Jump Backward', keys: ['Shift', 'left']},
        ],
      },
    ],
  },
  {
    id: 'audacity',
    appicon: 'qrc:/Images/audacity.png',
    title: 'Audacity',
    category: 'Media',
    description: 'Audacity audio editor shortcuts for efficient sound editing.',
    sets: [
      {
        title: 'Recording',
        id: 'recording',
        ...
        shortcuts: [
          {title: 'Record', keys: ['R']},
          {title: 'Play/Stop', keys: ['Space']},
          {title: 'Pause', keys: ['P']},
          {title: 'Select All', keys: ['Ctrl', 'A']},
          {title: 'Zoom In', keys: ['Ctrl', '1']},
          {title: 'Zoom Out', keys: ['Ctrl', '3']},
          {title: 'Fit in Window', keys: ['Ctrl', 'F']},
          {title: 'Delete', keys: ['Ctrl', 'K']},
  ...
  {
    id: 'obs',
    appicon: 'qrc:/Images/obs.png',
    title: 'OBS Studio',
    category: 'Media',
    description: 'OBS streaming and recording shortcuts for live content creation.',
    sets: [
      {
        title: 'Streaming',
        id: 'streaming',
        version: 1,
        shortcuts: [
          {title: 'Start/Stop Streaming', keys: ['Ctrl', 'Shift', 'S']},
          {title: 'Start/Stop Recording', keys: ['Ctrl', 'Shift', 'R']},
          {title: 'Pause Recording', keys: ['Ctrl', 'Shift', 'P']},
          {title: 'Mute/Unmute', keys: ['Ctrl', 'Shift', 'M']},
          {title: 'Studio Mode', keys: ['Ctrl', 'Shift', 'D']},
          {title: 'Toggle Preview', keys: ['Ctrl', 'Shift', 'V']},
          {title: 'Settings', keys: ['Ctrl', 'Shift', ',']},
          {title: 'Exit', keys: ['Ctrl', 'Q']},
          {title: 'Reset Transform', keys: ['Ctrl', 'R']},
          {title: 'Fit to Screen', keys: ['Ctrl', 'F']},
        ],
      },
    ],
  },
  {
    id: 'postman',
    appicon: 'qrc:/Images/postman.png',
    title: 'Postman',
    category: 'Development',
    description: 'Postman API testing shortcuts for faster API development.',
    sets: [
      {
        title: 'Requests',
        id: 'requests',
        version: 1,
        shortcuts: [
          {title: 'New Request', keys: ['Ctrl', 'N']},
          {title: 'Send Request', keys: ['Ctrl', 'Enter']},
          {title: 'Save Request', keys: ['Ctrl', 'S']},
          {title: 'New Tab', keys: ['Ctrl', 'T']},
          {title: 'Close Tab', keys: ['Ctrl', 'W']},
          {title: 'Search', keys: ['Ctrl', 'K']},
          {title: 'Toggle Sidebar', keys: ['Ctrl', '\\']},
          {title: 'Beautify JSON', keys: ['Ctrl', 'B']},
          {title: 'Toggle Console', keys: ['Ctrl', 'Alt', 'C']},
          {title: 'Settings', keys: ['Ctrl', ',']},
        ],
      },
    ],
  ...
  {
    id: 'nautilus',
    appicon: 'qrc:/Images/nautilus.png',
    title: 'Nautilus Files',
    category: 'Productivity',
    description: 'GNOME Files (Nautilus) shortcuts for efficient file management.',
    sets: [
      {
        title: 'Navigation',
        id: 'navigation',
        version: 1,
        shortcuts: [
          {title: 'New Window', keys: ['Ctrl', 'N']},
          {title: 'New Tab', keys: ['Ctrl', 'T']},
          {title: 'Close Tab', keys: ['Ctrl', 'W']},
          {title: 'Go to Location', keys: ['Ctrl', 'L']},
          {title: 'New Folder', keys: ['Ctrl', 'Shift', 'N']},
          {title: 'Search', keys: ['Ctrl', 'F']},
          {title: 'Show Hidden Files', keys: ['Ctrl', 'H']},
          {title: 'Toggle Sidebar', keys: ['F9']},
          {title: 'View as List', keys: ['Ctrl', '2']},
          {title: 'Delete', keys: ['Delete']},
        ],
      },
    ],
  },
  {
    id: 'gedit',
    appicon: 'qrc:/Images/gedit.png',
    title: 'gedit',
    category: 'Development',
    description: 'GNOME Text Editor shortcuts for quick text editing.',
    sets: [
      {
        title: 'Editing',
        id: 'editing',
        ...
        shortcuts: [
          ...
          {title: 'Find', keys: ['Ctrl', 'F']},
          {title: 'Replace', keys: ['Ctrl', 'H']},
          {title: 'Go to Line', keys: ['Ctrl', 'I']},
          {title: 'Toggle Comment', keys: ['Ctrl', 'M']},
          {title: 'Preferences', keys: ['Ctrl', 'Shift', 'P']},
          {title: 'Quit', keys: ['Ctrl', 'Q']},
        ],
      },
    ],
  },
  {
    id: 'inkscape',
    appicon: 'qrc:/Images/inkscape.png',
    title: 'Inkscape',
    category: 'Graphics',
    description: 'Inkscape vector graphics editor shortcuts for faster design work.',
    sets: [
      {
        title: 'Tools',
        id: 'tools',
        version: 1,
        shortcuts: [
          {title: 'Select Tool', keys: ['S']},
          {title: 'Node Tool', keys: ['N']},
          {title: 'Rectangle', keys: ['R']},
          {title: 'Circle', keys: ['C']},
          {title: 'Star', keys: ['*']},
          {title: 'Pen Tool', keys: ['B']},
          {title: 'Text Tool', keys: ['T']},
          {title: 'Zoom Tool', keys: ['Z']},
          {title: 'Duplicate', keys: ['Ctrl', 'D']},
  ...
  {
    id: 'krita',
    appicon: 'qrc:/Images/krita.png',
    title: 'Krita',
    category: 'Graphics',
    description: 'Krita digital painting shortcuts for artists.',
    sets: [
      {
        title: 'Painting',
        id: 'painting',
        version: 1,
        shortcuts: [
          {title: 'Brush Tool', keys: ['B']},
          {title: 'Eraser', keys: ['E']},
          {title: 'Fill Tool', keys: ['F']},
          {title: 'Gradient', keys: ['G']},
          {title: 'Color Picker', keys: ['P']},
          {title: 'New Layer', keys: ['Insert']},
          {title: 'Merge Down', keys: ['Ctrl', 'E']},
          {title: 'Flip Canvas', keys: ['M']},
          {title: 'Rotate Canvas', keys: ['Shift', 'Space']},
          {title: 'Reset Canvas', keys: ['5']},
        ],
      },
    ],
  },
  {
    id: 'blender',
    appicon: 'qrc:/Images/blender.png',
    title: 'Blender',
    category: 'Graphics',
    description: 'Blender 3D creation shortcuts for modeling and animation.',
    sets: [
      {
        title: 'Essential',
        id: 'essential',
        version: 1,
        shortcuts: [
          {title: 'Add Object', keys: ['Shift', 'A']},
          {title: 'Delete', keys: ['X']},
          {title: 'Duplicate', keys: ['Shift', 'D']},
          {title: 'Grab/Move', keys: ['G']},
          {title: 'Rotate', keys: ['R']},
          {title: 'Scale', keys: ['S']},
          {title: 'Tab to Edit Mode', keys: ['Tab']},
          {title: 'Camera View', keys: ['Numpad', '0']},
          {title: 'Render', keys: ['F12']},
          {title: 'Play Animation', keys: ['Space']},
        ],
      },
    ],
  },
  {
    id: 'kdenlive',
    appicon: 'qrc:/Images/kdenlive.png',
    title: 'Kdenlive',
    category: 'Media',
    description: 'Kdenlive video editing shortcuts for efficient editing.',
    sets: [
      {
        title: 'Editing',
        id: 'editing',
        ...
        shortcuts: [
          {title: 'Play/Pause', keys: ['Space']},
          {title: 'Split Clip', keys: ['Shift', 'R']},
          {title: 'Razor Tool', keys: ['X']},
          {title: 'Undo', keys: ['Ctrl', 'Z']},
          {title: 'Redo', keys: ['Ctrl', 'Shift', 'Z']},
          {title: 'Add Marker', keys: ['*']},
          {title: 'Zoom In', keys: ['Ctrl', '+']},
          {title: 'Zoom Out', keys: ['Ctrl', '-']},
          {title: 'Render', keys: ['Ctrl', 'Enter']},
          {title: 'Insert Clip', keys: ['I']},
        ],
      },
    ],
  },
  {
    id: 'calibre',
    appicon: 'qrc:/Images/calibre.png',
    title: 'Calibre',
    category: 'Productivity',
    description: 'Calibre eBook manager shortcuts for library management.',
    sets: [
      {
        title: 'Library',
        id: 'library',
        version: 1,
        shortcuts: [
          {title: 'Add Books', keys: ['A']},
          {title: 'Edit Metadata', keys: ['E']},
          {title: 'Convert Books', keys: ['C']},
          {title: 'View Book', keys: ['V']},
          {title: 'Delete Book', keys: ['Delete']},
          {title: 'Search', keys: ['Ctrl', 'F']},
          {title: 'Send to Device', keys: ['S']},
          {title: 'Edit Book', keys: ['T']},
          {title: 'Polish Book', keys: ['P']},
          {title: 'Preferences', keys: ['Ctrl', 'P']},
        ],
      },
    ],
  },
  {
    id: 'transmission',
    appicon: 'qrc:/Images/transmission.png',
    title: 'Transmission',
    category: 'Productivity',
    description: 'Transmission BitTorrent client shortcuts.',
    sets: [
      {
        title: 'Torrents',
        id: 'torrents',
        version: 1,
        shortcuts: [
          {title: 'Open Torrent', keys: ['Ctrl', 'O']},
          {title: 'New Torrent', keys: ['Ctrl', 'N']},
          {title: 'Start Torrent', keys: ['Ctrl', 'S']},
          {title: 'Pause Torrent', keys: ['Ctrl', 'P']},
          {title: 'Remove Torrent', keys: ['Delete']},
          {title: 'Properties', keys: ['Alt', 'Enter']},
          {title: 'Select All', keys: ['Ctrl', 'A']},
          {title: 'Toggle Filter', keys: ['Ctrl', 'T']},
          {title: 'Preferences', keys: ['Ctrl', ',']},
          {title: 'Quit', keys: ['Ctrl', 'Q']},
        ],
      },
    ],
  ...
  {
    id: 'lutris',
    appicon: 'qrc:/Images/lutris.png',
    title: 'Lutris',
    category: 'Gaming',
    description: 'Lutris gaming platform shortcuts for game management.',
    sets: [
      {
        title: 'Games',
        id: 'games',
        version: 1,
        shortcuts: [
          {title: 'Add Game', keys: ['Ctrl', 'N']},
          {title: 'Search Games', keys: ['Ctrl', 'F']},
          {title: 'Configure Game', keys: ['Ctrl', 'E']},
          {title: 'Remove Game', keys: ['Delete']},
          {title: 'View Logs', keys: ['Ctrl', 'L']},
          {title: 'Refresh Library', keys: ['F5']},
          {title: 'Grid View', keys: ['Ctrl', 'G']},
          {title: 'List View', keys: ['Ctrl', 'T']},
          {title: 'Preferences', keys: ['Ctrl', 'P']},
          {title: 'Quit', keys: ['Ctrl', 'Q']},
        ],
      },
  ...
  {
    id: 'keepassxc',
    appicon: 'qrc:/Images/keepassxc.png',
    title: 'KeePassXC',
    category: 'Productivity',
    description: 'KeePassXC password manager shortcuts for secure password management.',
    sets: [
      {
        title: 'Database',
        id: 'database',
        version: 1,
        shortcuts: [
          {title: 'New Entry', keys: ['Ctrl', 'N']},
          {title: 'Edit Entry', keys: ['Ctrl', 'E']},
          {title: 'Delete Entry', keys: ['Ctrl', 'D']},
          {title: 'Copy Username', keys: ['Ctrl', 'B']},
          {title: 'Copy Password', keys: ['Ctrl', 'C']},
          {title: 'Auto-Type', keys: ['Ctrl', 'Shift', 'V']},
          {title: 'Search', keys: ['Ctrl', 'F']},
          {title: 'Lock Database', keys: ['Ctrl', 'L']},
          {title: 'Save Database', keys: ['Ctrl', 'S']},
          {title: 'Settings', keys: ['Ctrl', ',']},
        ],
      },
    ],
